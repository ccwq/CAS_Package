package che
{
	...
	public class FontManager extends EventDispatcher
	{
		...
		public static function setTest(textField:TextField, text:String, fontName:String):void
		{
			...
			setTextFont(textField, fontName, text);
		}
		
		public static function setAllTextFont(textFieldList:Array,fontName:String):void {
			for (var i in textFieldList) {
				setTextFont(textFieldList[0],fontName);
			}
		}
		
		public static function setTextFont(textField:TextField, fontName:String, text:String = null):void { 
			if(textField == null) return;
